Contributing to Uzlocoin Core
============================

The Uzlocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Uzlocoin Core project, and is not to be
confused with overall Uzlocoin Network Protocol consensus changes.

Whether a pull request is merged into Uzlocoin Core rests with the project merge
...
Patches that change Uzlocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Uzlocoin consensus, it must have been
...
The project leader is the release manager for each Uzlocoin Core release.
