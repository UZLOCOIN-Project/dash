...
RESOURCES += src/qt/uzlocoin.qrc src/qt/uzlocoin_locale.qrc

TRANSLATIONS += src/qt/locale/uzlocoin_bg.ts \
                src/qt/locale/uzlocoin_de.ts \
                src/qt/locale/uzlocoin_en.ts \
                src/qt/locale/uzlocoin_es.ts \
                src/qt/locale/uzlocoin_fi.ts \
                src/qt/locale/uzlocoin_fr.ts \
                src/qt/locale/uzlocoin_it.ts \
                src/qt/locale/uzlocoin_ja.ts \
                src/qt/locale/uzlocoin_pl.ts \
                src/qt/locale/uzlocoin_pt.ts \
                src/qt/locale/uzlocoin_ru.ts \
                src/qt/locale/uzlocoin_sk.ts \
                src/qt/locale/uzlocoin_sv.ts \
                src/qt/locale/uzlocoin_vi.ts \
                src/qt/locale/uzlocoin_zh_CN.ts \
                src/qt/locale/uzlocoin_zh_TW.ts
