...
In order to support loading of multiple wallets in uzlocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is uzlocoin.cpp.
...
Changes to uzlocoin.cpp
----------------------
uzlocoin.cpp is the entry point into uzlocoin-qt, and as such, will require some minor modifications to provide hooks for
