...
Uzlocoin Core version 1.2.1 is now available from:
...
- Fix for possible fork regarding zUZL
...
Uzlocoin will now be switching to a more standard semantic versioning
