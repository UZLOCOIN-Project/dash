...
This mechanism has been integrated into Bitcore-Node-UZlocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/uzlocoinproject/insight-api-uzlocoin#web-socket-api](https://github.com/uzlocoinproject/insight-api-uzlocoin#web-socket-api) 
* API: [https://github.com/uzlocoinproject/insight-api-uzlocoin#swifttx-transactions](https://github.com/uzlocoinproject/insight-api-uzlocoin#swifttx-transactions) 
...
By default, the Uzlocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Uzlocoin Core daemon:
