...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // Uzlocoin: 1 minute
        nStakeMinDepth = 600;
        ...
        vSeeds.push_back(CDNSSeedData("0", "45.93.100.49")); // run by Salley
        vSeeds.push_back(CDNSSeedData("1", "seeder.bitkeyocean.com")); // run by Isaac (itduncan)
        ...
        strObfuscationPoolDummyAddress = "UCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 10;  // Uzlocoin: 1 minute
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Uzlocoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Uzlocoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Uzlocoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Uzlocoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Uzlocoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        strObfuscationPoolDummyAddress = "UCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp";
        nBlockStakeModifierlV2 = 1; // this will be set at a later date
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetSpacing = 1 * 60;        // Uzlocoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1505224800;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
