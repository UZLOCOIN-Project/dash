...
/** 
    ...
    ****Note - for Uzlocoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of uzlocoin coming in to a transaction
