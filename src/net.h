...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemauzlocoinGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemauzlocoinGrant grantOutbound;
