                                                                                           ...
                                                                                           fCapsLock(false)
{
    ...
    ui->passEdit1->setMaxLength(MAX_PASSUZLASE_SIZE);
    ui->passEdit2->setMaxLength(MAX_PASSUZLASE_SIZE);
    ui->passEdit3->setMaxLength(MAX_PASSUZLASE_SIZE);
...
void AskPassphraseDialog::accept()
{
    if (!model)
        return;
    oldpass.reserve(MAX_PASSUZLASE_SIZE);
    newpass1.reserve(MAX_PASSUZLASE_SIZE);
    newpass2.reserve(MAX_PASSUZLASE_SIZE);
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR UZL</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Uzlocoin will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your UZLs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
