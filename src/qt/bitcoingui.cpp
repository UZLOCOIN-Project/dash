                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Uzlocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Uzlocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and uzlocoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUZL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Uzlocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Uzlocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Uzlocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Uzlocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Uzlocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Uzlocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Uzlocoin Core help message to get a list with possible Uzlocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Uzlocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Uzlocoin network", "", count));
}
...
{
    QString strTitle = tr("Uzlocoin Core"); // default title
