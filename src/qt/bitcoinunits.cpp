...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(UZL);
    unitlist.append(mUZL);
    unitlist.append(uUZL);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case UZL:
        return QString("uzlocoin");
    case mUZL:
        return QString("muzlocoin");
    case uUZL:
        return QString::fromUtf8("uuzlocoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case UZL:
            return QString("tUZL");
        case mUZL:
            return QString("mtUZL");
        case uUZL:
            return QString::fromUtf8("μtUZL");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case UZL:
            return QString("UZL");
        case mUZL:
            return QString("Milli-UZL (1 / 1" THIN_SP_UTF8 "000)");
        case uUZL:
            return QString("Micro-UZL (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case UZL:
            return QString("TestUZLs");
        case mUZL:
            return QString("Milli-TestUZL (1 / 1" THIN_SP_UTF8 "000)");
        case uUZL:
            return QString("Micro-TestUZL (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
