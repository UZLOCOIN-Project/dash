...
static const int MAX_PASSUZLASE_SIZE = 1024;

/* Uzlocoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Uzlocoin"
#define QAPP_ORG_DOMAIN "uzlocoin.org"
#define QAPP_APP_NAME_DEFAULT "Uzlocoin-Qt"
#define QAPP_APP_NAME_TESTNET "Uzlocoin-Qt-testnet"
