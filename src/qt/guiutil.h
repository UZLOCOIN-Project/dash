...
/** Utility functions used by the Uzlocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Uzlocoin addresses in monospace font
...
// Parse "uzlocoin:" URI into recipient object, return true on successful parsing
