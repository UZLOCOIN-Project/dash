...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Uzlocoin Core"),
     ...
     * override -datadir in the uzlocoin.conf file in the default data directory
     * (to be consistent with uzlocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
