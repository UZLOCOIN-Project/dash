 ...
 */
    ...
    typeWidget->addItem(tr("Received Uzl from zUzl"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zUzl"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUzl));
