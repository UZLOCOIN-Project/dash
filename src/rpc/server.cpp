...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Uzlocoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Uzlocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Uzlocoin features */
        {"uzlocoin", "masternode", &masternode, true, true, false},
        {"uzlocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"uzlocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"uzlocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"uzlocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"uzlocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"uzlocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"uzlocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"uzlocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"uzlocoin", "startmasternode", &startmasternode, true, true, false},
        {"uzlocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"uzlocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"uzlocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"uzlocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"uzlocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"uzlocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"uzlocoin", "mnbudget", &mnbudget, true, true, false},
        {"uzlocoin", "preparebudget", &preparebudget, true, true, false},
        {"uzlocoin", "submitbudget", &submitbudget, true, true, false},
        {"uzlocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"uzlocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"uzlocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"uzlocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"uzlocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"uzlocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"uzlocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"uzlocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"uzlocoin", "mnsync", &mnsync, true, true, false},
        {"uzlocoin", "spork", &spork, true, true, false},
        {"uzlocoin", "getpoolinfo", &getpoolinfo, true, true, false},
        {"uzlocoin", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> uzlocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6334/\n";
}
