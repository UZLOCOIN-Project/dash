...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Uzlocoin Core uzlocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  uzlocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded uzlocoin transaction") + "\n" +
                               "  uzlocoin-tx [options] -create [commands]   " + _("Create hex-encoded uzlocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded uzlocoin transaction
